...
import GreenLogo from './img/logo-green-2x.png';
    ...
    <div>
        ...
        <footer className="footer">
            <div className="footer__logo-box">
                <img src={GreenLogo} alt="logo" className="footer__logo" />
            </div>
            <div className="row">
                <div className="col-1-of-2">
                ...
                <div className="col-1-of-2">
                    <p className="footer__copyright">
                        Built By  <a href="/" className="footer__link">&copy; Yassine Ouri</a>  Lorem ipsum dolor sit, amet consectetur adipisicing elit. Exercitationem iure velit ducimus quos optio nobis error nihil cupiditate quisquam placeat. Quam fugit officiis dolorum nesciunt minima aspernatur, in ducimus vitae.
                    </p>
                </div>
            </div>
        </footer>
